...
/* The CJK Ext B kanji that JIS X 0213 plane 2 encodes. Rare kanji in classic Japanese texts
 * live outside the BMP -- Ogai's Vita Sexualis spells a character's name 蟋麻 (U+23D40) -- and
 * render as missing-glyph boxes when the charset stops at the BMP. Taking ALL of CJK Ext B is
 * not an option: the Japanese Noto fonts cover it so sparsely it costs ~1614 intervals against
 * ~65 today. This curated subset costs 263, and the reader keeps above-BMP intervals as an
 * on-card tail, so they add nothing to its resident table.
 *
 * fontconvert_sdcard.py derives these from Python's euc_jis_2004 codec, which browsers do not
 * have; this table is generated from that same function. Regenerate with:
 *   python3 -c "import sys; sys.path.insert(0,'<firmware>/lib/EpdFont/scripts'); \
 *               import fontconvert_sdcard as f; print(f.JISX0213_PLANE2)"
 */
const JISX0213_PLANE2 = [
  [0x20089, 0x20089], [0x200A2, 0x200A2], [0x200A4, 0x200A4], [0x201A2, 0x201A2],
  [0x20213, 0x20213], [0x2032B, 0x2032B], [0x20371, 0x20371], [0x20381, 0x20381],
  [0x203F9, 0x203F9], [0x2044A, 0x2044A], [0x20509, 0x20509], [0x205D6, 0x205D6],
  [0x20628, 0x20628], [0x2074F, 0x2074F], [0x20807, 0x20807], [0x2083A, 0x2083A],
  [0x208B9, 0x208B9], [0x2097C, 0x2097C], [0x2099D, 0x2099D], [0x20AD3, 0x20AD3],
  [0x20B1D, 0x20B1D], [0x20D45, 0x20D45], [0x20DE1, 0x20DE1], [0x20E64, 0x20E64],
  [0x20E6D, 0x20E6D], [0x20E95, 0x20E95], [0x20F5F, 0x20F5F], [0x21201, 0x21201],
  [0x21255, 0x21255], [0x21274, 0x21274], [0x2127B, 0x2127B], [0x212D7, 0x212D7],
  [0x212E4, 0x212E4], [0x212FD, 0x212FD], [0x21336, 0x21336], [0x21344, 0x21344],
  [0x213C4, 0x213C4], [0x2146D, 0x2146D], [0x215D7, 0x215D7], [0x21647, 0x21647],
  [0x21706, 0x21706], [0x21742, 0x21742], [0x219C3, 0x219C3], [0x21C56, 0x21C56],
  [0x21D2D, 0x21D2D], [0x21D45, 0x21D45], [0x21D62, 0x21D62], [0x21D78, 0x21D78],
  [0x21D92, 0x21D92], [0x21D9C, 0x21D9C], [0x21DA1, 0x21DA1], [0x21DB7, 0x21DB7],
  [0x21DE0, 0x21DE0], [0x21E33, 0x21E33], [0x21F1E, 0x21F1E], [0x21F76, 0x21F76],
  [0x21FFA, 0x21FFA], [0x2217B, 0x2217B], [0x22218, 0x22218], [0x2231E, 0x2231E],
  [0x223AD, 0x223AD], [0x226F3, 0x226F3], [0x2285B, 0x2285B], [0x228AB, 0x228AB],
  [0x2298F, 0x2298F], [0x22AB8, 0x22AB8], [0x22B46, 0x22B46], [0x22B4F, 0x22B50],
  [0x22BA6, 0x22BA6], [0x22C1D, 0x22C1D], [0x22C24, 0x22C24], [0x22DE1, 0x22DE1],
  [0x231B6, 0x231B6], [0x231C3, 0x231C3], [0x231F5, 0x231F5], [0x23372, 0x23372],
  [0x233D0, 0x233D0], [0x233D2, 0x233D3], [0x233D5, 0x233D5], [0x233DA, 0x233DA],
  [0x233DF, 0x233DF], [0x233E4, 0x233E4], [0x2344A, 0x2344B], [0x23451, 0x23451],
  [0x23465, 0x23465], [0x234E4, 0x234E4], [0x2355A, 0x2355A], [0x23594, 0x23594],
  [0x2808A, 0x2808A], [0x280BB, 0x280BB], [0x28282, 0x28282], [0x282F3, 0x282F3],
  [0x2840C, 0x2840C], [0x28455, 0x28455], [0x2856B, 0x2856B], [0x285C8, 0x285C9],
  [0x286D7, 0x286D7], [0x286FA, 0x286FA], [0x28946, 0x28946], [0x28949, 0x28949],
  [0x2896B, 0x2896B], [0x28987, 0x28988], [0x289BA, 0x289BB], [0x28A1E, 0x28A1E],
  [0x28A29, 0x28A29], [0x28A43, 0x28A43], [0x28A71, 0x28A71], [0x28A99, 0x28A99],
  [0x28ACD, 0x28ACD], [0x28ADD, 0x28ADD], [0x28AE4, 0x28AE4], [0x28BC1, 0x28BC1],
  [0x28BEF, 0x28BEF], [0x28D10, 0x28D10], [0x28D71, 0x28D71], [0x28DFB, 0x28DFB],
  [0x28E1F, 0x28E1F], [0x28E36, 0x28E36], [0x28E89, 0x28E89], [0x28EEB, 0x28EEB],
  [0x28F32, 0x28F32], [0x28FF8, 0x28FF8], [0x292A0, 0x292A0], [0x292B1, 0x292B1],
  [0x29490, 0x29490], [0x295CF, 0x295CF], [0x2967F, 0x2967F], [0x296F0, 0x296F0],
  [0x29719, 0x29719], [0x29750, 0x29750], [0x298C6, 0x298C6], [0x29A72, 0x29A72],
  [0x29DDB, 0x29DDB], [0x29E15, 0x29E15], [0x29E3D, 0x29E3D], [0x29E49, 0x29E49],
  [0x29E8A, 0x29E8A], [0x29EC4, 0x29EC4], [0x29EDB, 0x29EDB], [0x29EE9, 0x29EE9],
  [0x29FCE, 0x29FCE], [0x2A01A, 0x2A01A], [0x2A02F, 0x2A02F], [0x2A082, 0x2A082],
  [0x2A0F9, 0x2A0F9], [0x2A38C, 0x2A38C], [0x2A437, 0x2A437], [0x2A5F1, 0x2A5F1],
  [0x2A602, 0x2A602], [0x2A61A, 0x2A61A], [0x2A6B2, 0x2A6B2]
];
...
const INTERVAL_PRESETS = {
  ...
  // 21 BMP ranges + JIS X 0213 plane 2. Was missing Box Drawing (0x2500-0x257F) and the
  // whole plane-2 tail, so a font built here lacked rare kanji the firmware's own build has.
  "cjk-ext":     [
  [0x2100, 0x214F], [0x2150, 0x218F], [0x2190, 0x21FF], [0x2460, 0x24FF], [0x2500, 0x257F],
  [0x25A0, 0x25FF], [0x2600, 0x26FF], [0x2E80, 0x2EFF], [0x2F00, 0x2FDF], [0x3000, 0x303F],
  [0x3040, 0x309F], [0x30A0, 0x30FF], [0x3100, 0x312F], [0x3190, 0x319F], [0x31F0, 0x31FF],
  [0x3200, 0x32FF], [0x3300, 0x33FF], [0x4E00, 0x9FFF], [0xF900, 0xFAFF], [0xFE30, 0xFE4F],
  [0xFF00, 0xFFEF],
                  ...JISX0213_PLANE2],
...
if (typeof document !== "undefined" && document.getElementById("font-run")) {
  ...
  // "all" is the one coverage choice that can quietly cost the device tens of KB of RAM for the
  // life of the font -- it records one interval per contiguous run of glyphs actually present,
  // and a broad CJK face is covered too sparsely for that to stay small. Surface the cost while
  // the choice is still cheap to change, rather than after a multi-minute build.
  const allBox = document.querySelector('.font-preset[value="all"]');
  const warning = document.getElementById("font-all-warning");
  if (allBox && warning) {
    const sync = () => { warning.hidden = !allBox.checked; };
